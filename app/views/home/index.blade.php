  ...
  <table class="table table-bordered" style="width: auto;">
    ...
    <tbody>
      <tr>
        ...
        <td id="data-all"><img src="/packages/icons/ajax-loader.gif" alt="загрузка"></td>
      </tr>
      <tr>
        <th>Доменов отвечают</th>
        <td id="data-s1"><img src="/packages/icons/ajax-loader.gif" alt="загрузка"></td>
      </tr>
      <tr>
        <th>Домены со страницами</th>
        <td id="data-s2"><img src="/packages/icons/ajax-loader.gif" alt="загрузка"></td>
      </tr>
      <tr>
        <th>Домены с контактами</th>
        <td id="data-s3"><img src="/packages/icons/ajax-loader.gif" alt="загрузка"></td>
      </tr>
      <tr>
        <th>Проверенные домены</th>
        <td id="data-s4"><img src="/packages/icons/ajax-loader.gif" alt="загрузка"></td>
      </tr>
    </tbody>
  </table>
